...
const translations = {
  lv: {
    ...
    landing: {
      badge: "Digitālā reklāma · LTD Production",
      headline1: "Reklāma, kas atved klientus,",
      headline2: "nevis tikai klikšķus",
      sub: "Mērķētas Facebook, Instagram un Google kampaņas tavam biznesam. Pirmā konsultācija — bezmaksas, atbilde 24 stundu laikā.",
      cta: "Pieteikties bezmaksas konsultācijai",
      guarantee: "Bez maksas · Bez saistībām · Atbilde 24h laikā",
      benefits: [
        { title: "Precīza mērķēšana", desc: "Tavu reklāmu redz cilvēki, kuri tiešām meklē tavu pakalpojumu — pēc vietas, vecuma un interesēm." },
        { title: "Skaidras atskaites", desc: "Katru mēnesi redzi, cik cilvēku redzēja reklāmu, cik noklikšķināja un cik kļuva par klientiem." },
        { title: "Bez ilgtermiņa līgumiem", desc: "Maksā par mēnesi un atcel jebkurā brīdī — klientus noturam ar rezultātiem, nevis līgumiem." },
      ],
  ...
  en: {
    ...
    landing: {
      badge: "Digital advertising · LTD Production",
      headline1: "Ads that bring customers,",
      headline2: "not just clicks",
      sub: "Targeted Facebook, Instagram and Google campaigns for your business. First consultation is free — we reply within 24 hours.",
      cta: "Book a free consultation",
      guarantee: "Free · No obligations · Reply within 24h",
      benefits: [
        { title: "Precise targeting", desc: "Your ads are seen by people who are actually looking for your service — by location, age and interests." },
        { title: "Clear reporting", desc: "Every month you see how many people saw the ad, clicked and became customers." },
        { title: "No long-term contracts", desc: "Pay monthly and cancel anytime — we keep clients with results, not contracts." },
      ],
