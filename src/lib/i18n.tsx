...
const translations = {
  lv: {
    ...
    landing: {
      ...
      headline2: "kas atved klientus",
      sub: "Izveidojam mūsdienīgas mājas lapas un vadām mērķētas reklāmas kampaņas Facebook, Instagram un Google. Pirmā konsultācija — bezmaksas, atbilde 24 stundu laikā.",
      cta: "Pieteikties bezmaksas konsultācijai",
      guarantee: "Bez maksas · Bez saistībām · Atbilde 24h laikā",
      services: [
        {
        ...
        {
          name: "Reklāmas kampaņas",
          price: "no €299/mēn",
          desc: "Mērķētas Facebook, Instagram un Google reklāmas, kas sasniedz tieši tavus klientus.",
          features: ["Precīza auditorijas mērķēšana", "Reklāmas vizuāļu dizains", "Iknedēļas optimizācija", "Skaidras ikmēneša atskaites", "Bez ilgtermiņa līgumiem"],
          cta: "Gribu reklāmu",
        },
      ],
      stats: [
        { metric: "30+", label: "Pabeigti projekti" },
        { metric: "3×", label: "Vidējais ROAS reklāmām" },
        { metric: "7–14 d.", label: "Mājas lapa no idejas līdz palaišanai" },
        { metric: "24h", label: "Atbilde uz pieteikumu" },
      ],
      benefits: [
        { title: "Viss vienuviet", desc: "Mājas lapa un reklāma no vienas komandas — saskaņots dizains, vēstījums un mērķi, bez starpniekiem." },
        { title: "Skaidras atskaites", desc: "Katru mēnesi redzi, cik cilvēku redzēja reklāmu, apmeklēja lapu un kļuva par klientiem." },
        { title: "Bez ilgtermiņa līgumiem", desc: "Maksā par padarīto un atcel jebkurā brīdī — klientus noturam ar rezultātiem, nevis līgumiem." },
      ],
      formTitle: "Piesakies bezmaksas konsultācijai",
      formSub: "Aizpildi formu — sazināsimies 24 stundu laikā un izstrādāsim plānu tieši tavam biznesam.",
      footerNote: "LTD Production · Cēsis, Latvija",
    },
    intro: {},
    website: {
    ...
    projekti: {
      ...
      items: [
        ...
        { title: "Turbocrete.eu — Betona pakalpojumi", category: "Business Website", description: "Profesionāla mājas lapa betona un būvniecības pakalpojumu uzņēmumam ar pakalpojumu prezentāciju un kontaktformu.", img: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80", href: "https://turbocrete.eu/", year: "2026", tags: ["Next.js", "Tailwind", "SEO"] },
  ...
  en: {
    ...
    landing: {
      ...
      headline2: "that bring customers",
      sub: "We build modern websites and run targeted ad campaigns on Facebook, Instagram and Google. First consultation is free — we reply within 24 hours.",
      cta: "Book a free consultation",
      guarantee: "Free · No obligations · Reply within 24h",
      services: [
        {
        ...
        },
        {
          name: "Ad campaigns",
          price: "from €299/mo",
          desc: "Targeted Facebook, Instagram and Google ads that reach exactly your customers.",
          features: ["Precise audience targeting", "Ad visual design", "Weekly optimisation", "Clear monthly reports", "No long-term contracts"],
          cta: "I want ads",
        },
      ],
      stats: [
        { metric: "30+", label: "Completed projects" },
        { metric: "3×", label: "Average ROAS on ads" },
        { metric: "7–14 d.", label: "Website from idea to launch" },
        { metric: "24h", label: "Reply to your request" },
      ],
      benefits: [
        { title: "Everything in one place", desc: "Website and advertising from one team — consistent design, message and goals, no middlemen." },
        { title: "Clear reporting", desc: "Every month you see how many people saw the ad, visited the site and became customers." },
        { title: "No long-term contracts", desc: "Pay for what gets done and cancel anytime — we keep clients with results, not contracts." },
      ],
      formTitle: "Book your free consultation",
      formSub: "Fill in the form — we'll get in touch within 24 hours and build a plan for your business.",
      footerNote: "LTD Production · Cēsis, Latvia",
    },
    intro: {},
    website: {
    ...
    projekti: {
      ...
      items: [
        ...
        { title: "Turbocrete.eu — Concrete services", category: "Business Website", description: "Professional website for a concrete and construction services company with service showcase and contact form.", img: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80", href: "https://turbocrete.eu/", year: "2026", tags: ["Next.js", "Tailwind", "SEO"] },
